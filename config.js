...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("0768600285")
...
global.sudo = process.env.SUDO || '94768600285'
global.devs = '94768600285';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'NOTY VAJIRA 𝐁𝐨𝐭' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME ===  undefined? 'PASIYA' : process.env.OWNER_NAME,
